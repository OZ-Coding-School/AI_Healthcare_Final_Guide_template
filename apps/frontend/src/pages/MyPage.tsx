  ...
  return (
    <div className="flex items-center gap-4 py-3.5 border-b border-border last:border-0">
      ...
      <div className="flex-1 min-w-0 flex items-center justify-between gap-3">
        ...
        <span
          className={cn("text-sm font-medium text-foreground truncate", mono && "font-mono")}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-white border border-border rounded-xl p-6 flex items-center gap-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div
                className="flex items-center gap-2 text-xs font-medium px-2.5 py-1 rounded-full inline-flex"
          ...
          <div className="bg-white border border-border rounded-xl overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <Field
                ...
                hint="예: 010-1234-5678 또는 +821012345678"
              >
                <input
                  type="tel"
                  ...
                  className={INPUT}
                  style={{
                    borderColor: errors.phone_number ? "#EF4444" : "rgba(13,59,110,0.2)",
