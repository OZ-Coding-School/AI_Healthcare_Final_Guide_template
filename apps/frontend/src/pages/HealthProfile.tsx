...
import { Pencil, CheckCircle, X, AlertCircle, Plus, Loader2 } from "lucide-react";
import {
  getHealthProfile,
  createHealthProfile,
  updateHealthProfile,
  HealthProfile as HealthProfileData,
  Gender,
...
function Toggle({
  ...
  return (
    <button
      ...
      style={{
        borderColor: checked ? "rgba(13,59,110,0.3)" : "rgba(0,0,0,0.1)",
        backgroundColor: checked ? "rgba(13,59,110,0.04)" : "transparent",
      }}
    >
...
function InfoRow({
  ...
  return (
    <div className="flex items-center justify-between py-3 border-b border-border last:border-0">
      ...
      <span
        className={cn("text-sm font-medium text-foreground", mono && "font-mono")}
...
export default function HealthProfile() {
  ...
  const validate = (isCreate: boolean) => {
    ...
    if (!form.height || isNaN(h) || h <= 0 || h > 300)
      e.height = "키를 올바르게 입력해주세요. (0 초과 300 이하)";
    if (!form.weight || isNaN(w) || w <= 0 || w > 500)
      e.weight = "몸무게를 올바르게 입력해주세요. (0 초과 500 이하)";
    return e;
  };
    ...
    <div className="p-6 lg:p-8 max-w-2xl" style={{ fontFamily: "Outfit, sans-serif" }}>
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {mode === "create"
                ? "AI 분석의 기준이 될 기본 건강 정보를 등록해주세요."
                : "AI 분석의 기준이 되는 기본 건강 정보입니다."}
            </p>
          </div>
          {mode === "view" && (
            <button
      ...
      {mode === "view" && profile && (
        <div className="flex flex-col gap-5">
              ...
              <InfoRow
                ...
                value={
                  <span
                    ...
                    style={{
                      fontFamily: "JetBrains Mono",
                      backgroundColor: profile.has_diabetes
                        ? "rgba(245,158,11,0.1)"
                        : "rgba(16,185,129,0.1)",
              ...
              <InfoRow
                ...
                value={
                  <span
                    ...
                    style={{
                      fontFamily: "JetBrains Mono",
                      backgroundColor: profile.has_hypertension
                        ? "rgba(239,68,68,0.1)"
                        : "rgba(16,185,129,0.1)",
          ...
          {/* 메타 */}
          <div
            className="text-xs text-muted-foreground flex flex-col gap-1 px-1"
            style={{ fontFamily: "JetBrains Mono" }}
          >
              ...
              {mode === "create" ? (
                <Field label="생년월일" required error={errors.birth_date} hint="형식: YYYY-MM-DD">
                  <input
                    ...
                    className={INPUT}
                    style={{
                      borderColor: errors.birth_date ? "#EF4444" : "rgba(13,59,110,0.2)",
                      fontFamily: "JetBrains Mono",
                    }}
                  />
                </Field>
                ...
                (() => {
                  ...
                  return previewBmi && info ? (
                    ...
                    >
                      ...
                      <span
                        className="font-bold"
                        style={{ fontFamily: "JetBrains Mono", color: info.color }}
                      >
                        {previewBmi}
                      </span>
                      <span
          ...
          <div className="bg-white border border-border rounded-xl overflow-hidden">
            ...
            <div className="p-5 flex flex-col gap-3">
              ...
              <Toggle
                ...
                onChange={(v) => set("has_hypertension")(v)}
                label="고혈압 (진단받은 경우)"
              />
            </div>
          </div>
