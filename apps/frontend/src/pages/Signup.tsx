  ...
  return (
    <li className="flex items-center gap-2 text-xs">
      {ok ? (
        ...
        <XCircle size={13} className="text-muted-foreground opacity-40" />
      )}
...
export default function Signup() {
  ...
  const validate = () => {
    ...
    if (!phoneRe.test(form.phone.replace(/-/g, "")))
      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            건강한 내일을
            <br />
            <span style={{ color: "#10B981" }}>지금 시작하세요</span>
          </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div
              ...
              style={{
                borderColor: codeVerified ? "rgba(16,185,129,0.3)" : "rgba(13,59,110,0.12)",
                backgroundColor: codeVerified ? "rgba(16,185,129,0.04)" : "transparent",
              }}
            >
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className={cn(
                      INPUT_BASE,
                      "flex-1",
                      codeVerified && "opacity-60 cursor-not-allowed"
                    )}
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        ...
                        style={{
                          borderColor: errors.code ? "#EF4444" : "rgba(13,59,110,0.2)",
                    ...
                    <button
                      type="button"
                      onClick={verifyCode}
                      disabled={verifyingCode || form.code.length !== 6}
            ...
            <Field label="비밀번호" required error={errors.password}>
              ...
              {form.password && (
                <ul className="grid grid-cols-2 gap-x-4 gap-y-1.5 mt-2">
                  {PW_RULES.map((r, i) => (
                    <PasswordRule key={r.id} ok={pwOk[i]} label={r.label} />
                  ))}
                </ul>
              )}
            </Field>
            ...
            <Field
              ...
              required
              error={errors.phone}
              hint="인증 없이 저장됩니다. (예: 01012345678)"
            >
              <input
                type="tel"
                ...
                className={INPUT_BASE}
                style={{
                  borderColor: errors.phone ? "#EF4444" : "rgba(13,59,110,0.2)",
                  fontFamily: "JetBrains Mono",
                }}
              />
            </Field>
