...
from app.core.utils.jwt.exceptions import ExpiredTokenError, TokenBackendError, TokenBackendExpiredError, TokenError
from app.core.utils.jwt.state import token_backend
...
class Token:
    ...
    def __init__(self, token: str | None = None, verify: bool = True) -> None:
        ...
        self.token = token
        self.current_time = datetime.now(tz=settings.TIMEZONE)
